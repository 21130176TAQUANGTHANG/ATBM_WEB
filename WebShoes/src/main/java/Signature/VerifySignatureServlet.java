    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            ...
            if (publicKeyString == null || publicKeyString.isEmpty()) {
                // Nếu không tìm thấy public key, thông báo cho người dùng
                req.setAttribute("error", "Public key not found for the user. Please ensure the user has registered their public key.");
                req.getRequestDispatcher("verifySignature.jsp").forward(req, resp);
                return;
            }
